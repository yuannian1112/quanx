...
必须填一个地址
[task_local]
0 15 * * * https://raw.githubusercontent.com/xzxxn777/quanx/main/HYFLS/HYFLS_TASK.js, tag=汇源福利社-开盲盒, enabled=true
[MITM]
hostname = huiyuan.timingmar.com
[rewrite_local]
# 汇源福利社获取cookie
^https:\/\/huiyuan\.timingmar\.com\/hy-api\/mc\/eu\/address\/list url script-request-header https://raw.githubusercontent.com/xzxxn777/quanx/main/HYFLS/HYFLS_TASK.js
*/
const $ = new Env('汇源福利社-开盲盒');
...
!(async () => {
    if (isRequest) {
        ...
        let codeArr = await Variable_Check(codeStr, "HYFLSCODE");
        for (let index = 0; index < ckArr.length; index++) {
            let num = index + 1;
            $.isLogin = true;
            console.log(`\n-------- 开始【第 ${num} 个账号】--------`);
...
function help(cookie,id) {
    return new Promise(resolve => {
        const options = {
            url: `https://huiyuan.timingmar.com/hy-api/lottery/activity/get-ticket-new?activityId=6&linkCode=${id}`,
            headers: {
                "Host": "huiyuan.timingmar.com",
                "Accept": "application/json, text/plain, */*",
                "Accept-Encoding": "gzip, deflate",
...
function getNum(cookie) {
    return new Promise(resolve => {
        const options = {
            url: `https://huiyuan.timingmar.com/hy-api/lottery/activity/time?id=6&noLoad=true`,
            headers: {
                "Host": "huiyuan.timingmar.com",
                "Accept": "application/json, text/plain, */*",
                "Accept-Encoding": "gzip, deflate",
...
function open(cookie) {
    return new Promise(resolve => {
        const options = {
            url: `https://huiyuan.timingmar.com/hy-api/lottery/activity/get-prize?id=6&noLoad=true&prizeChannel=1`,
            headers: {
                "Host": "huiyuan.timingmar.com",
                "Accept": "application/json, text/plain, */*",
                "Accept-Encoding": "gzip, deflate",
